...
def train(
    ...
    train_set = HazyMNIST(root=data_dir, train=True, img_size=img_size)
    vis_set = HazyMNIST(root=data_dir, train=False, img_size=img_size, fixed_fog=False)
...
def main():
    p = argparse.ArgumentParser(description="MNIST dehazing toy example.")
    ...
    p.add_argument("--output_dir", type=str, default="./outputs/dehaze")
